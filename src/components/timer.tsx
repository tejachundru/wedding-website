  ...
  return (
    <div className={isDanger ? "countdown danger" : "countdown"}>
      <div className="value text-base flex row items-end mr-2">
        <p className="text-5xl font-bold mr-1 hover:text-4xl animate-pulse hover:cursor-pointer transition duration-800 text-red-500">
          {value}
        </p>{" "}
        <p className="text-xl">{type === "Days" ? "Days" : type}</p>
      </div>
    </div>
  );
};
